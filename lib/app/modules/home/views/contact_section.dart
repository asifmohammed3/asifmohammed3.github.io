    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          const Text(
            "Let's connect! I'm always excited to discuss new opportunities, collaborate on interesting projects, or simply chat about ideas. Whether you're looking to hire, partner, or just want to say hello, I'd love to hear from you.",
            style: TextStyle(color: Colors.white70),
          ),
          const SizedBox(height: 24),
          Row(
